...
*/
  ...
  for (key in metrics.counters) {
    ...
    "service":listKeys[1] || '',
    "event":listKeys[2] || '',
    "application":listKeys[3] || '',
    "rule":listKeys[4] || '',
    "object_type":listKeys[5] || '',
    "object":listKeys[6] || '',
    "adaptor":listKeys[7] || '',
    "action_type":listKeys[8] || '',
    "value":value,
    "timestamp": ts
  });
  ...
  for (key in metrics.timer_data) {
    ...
    value["service"] = listKeys[1] || '';
    value["event"] = listKeys[2] || '';
    value["application"] = listKeys[3] || '';
    value["rule"] = listKeys[4] || '';
    value["object_type"] = listKeys[5] || '';
    value["object"] = listKeys[6] || '';
    value["adaptor"] = listKeys[7] || '';
    value["action_type"] = listKeys[8] || '';
    if (value['histogram']) {
